      ...
      <div className="home__container container grid">
        <div className="home__content grid">
          <div className="home__social">
            ...
            <a href="https://github.com/imyosh" target="_blank" className="home__social-icon">
              <i className="uil uil-github-alt"></i>
            </a>

            <a href="https://leetcode.com/yosh5511/" target="_blank" className="home__social-icon">
              <svg className="home__social-icon-leetcode">
                <use xlinkHref="img/leetcode.svg#leetcode"></use>
              </svg>
            </a>
          </div>
          ...
          <div className="home__img">
            ...
            >
              ...
              <g mask="url(#mask0)">
                ...
                />
                <image className="home__blob-img" x="30" y="-5" xlinkHref="/img/profile.png" />
              </g>
            </svg>
          </div>
